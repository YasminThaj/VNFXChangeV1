...
def launch_instances(arg1,arg2,arg3):
    ...
    # Creating Instances.
    stdin, stdout, stderr = ssh_obj.exec_command("source keystonerc_admin && nova boot --image "+arg1+" --flavor "+arg2+" --nic port-id=d65e484f-515b-4664-baf4-955e8a98017f --nic port-id=9edf3d21-62f5-4cca-8211-733ec1c8794c " + arg3)
    time.sleep(5)
    errout = stderr.read()
    if stdout:
        data = stdout.read()
...
if __name__ == "__main__":
    ...
    print "arg2 : " + arg2
    print "arg3 : " + arg3
    print launch_instances(img_name,flavor_name,vnf_name)